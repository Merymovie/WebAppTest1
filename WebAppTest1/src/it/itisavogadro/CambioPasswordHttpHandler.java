...
public class CambioPasswordHttpHandler implements HttpHandler {

    @Override
    public void handle(HttpExchange httpExchange) throws IOException {

        System.out.println("HTTP request CambiaPassword");
        ...
        if ("GET".equalsIgnoreCase(httpExchange.getRequestMethod())) {
            htmlResponse = "" +
                    "<html>" +
                    "<body>" +
                    "<h1>" + httpExchange.getRequestMethod() + "- Cambio Password Test - 1 App</h1>" +
                    ...
                    "<input type=nuovapassword name=\"nuovapassword\"><br>" +
                    //pulsante invio
            ...
            //la situa sarebbe: Variabilenome=Valoreinput&variabilenome=Valoreinput&variabile=input
            //& è il punto di split
            String params[] = paramLine.split("&");
            //le salvo nelle stringhe
            String user = "missing";
            String pass = "missing";
            String nuovapassword = "missing"; //nuova password
            ...
            for (String param : params) {
                ...
                String paramNewValue = param.split("=")[2];
                ...
                paramNewValue = java.net.URLDecoder.decode(paramNewValue, StandardCharsets.UTF_8.name());
                ...
                if ("password".equalsIgnoreCase(paramName)) {
                    pass = paramValue;
                    nuovapassword = paramNewValue;
                }
                //if ("nuovapassword".equalsIgnoreCase(paramName)){
                //    nuovapass = paramNewValue;
                //}
            }
